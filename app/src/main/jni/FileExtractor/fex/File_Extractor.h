...
#ifndef __FILE_EXTRACTOR_H__
#define __FILE_EXTRACTOR_H__
...
// Open/close
	...
	blargg_err_t open( File_Reader* input, const char* path = (char*)NULL );
...
protected:
	...
	void set_name( const char name [], const wchar_t* wname = (wchar_t*)NULL );
