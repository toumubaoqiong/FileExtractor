...
private:
	Std_File_Reader& operator=( const Std_File_Reader& );
	Std_File_Reader( const Std_File_Reader& );
...
private:
	Mem_File_Reader& operator=( const Mem_File_Reader& );
	Mem_File_Reader( const Mem_File_Reader& );
...
private:
	Callback_File_Reader& operator=( const Callback_File_Reader& );
	Callback_File_Reader( const Callback_File_Reader& );
