...
/*原本有如下定义，但报告  warning: multi-line comment，即 NOTHROW/new后面有反斜杠，取消掉了
#define BLARGG_DISABLE_NOTHROW  反斜杠取消了
//冲突 注释掉
//void* operator new ( size_t s ) BLARGG_THROWS_NOTHING { return malloc( s ); }  反斜杠取消了
